...
def update_profiles(request, data, **kwargs):
    ...
    if param3:
        ...
        cache.invalidate_by_id(param3, "profiles", kwargs.get('schema'))
        cache.invalidate_by_id(param3, "field_permissions", kwargs.get('schema'))
        cache.invalidate_all_by_table("field_permissions", kwargs.get('schema'))
        cache.invalidate_all_by_table("fields", kwargs.get('schema'))
    ...
    if object_permissions: 
        for obj in object_permissions:
            obj.pop("object", None)
        cache.invalidate_all_by_table('object_permissions', kwargs.get('schema'))
        cache.invalidate_all_by_table('objects', kwargs.get('schema'))
    ...
    if tab_permissions:
        for obj in tab_permissions:
            obj.pop("object", None)
        cache.invalidate_all_by_table('tab_permissions', kwargs.get('schema'))
        cache.invalidate_all_by_table('objects', kwargs.get('schema'))
        cache.invalidate_all_by_table('tabs', kwargs.get('schema'))
    ...
    if app_permissions:
        cache.invalidate_all_by_table('app_permissions', kwargs.get('schema'))
        cache.invalidate_all_by_table('apps', kwargs.get('schema'))
    ...
    if homepage_assignment:
        cache.invalidate_all_by_table('homepage_assignment', kwargs.get('schema'))
        cache.invalidate_all_by_table('page_builder', kwargs.get('schema'))
